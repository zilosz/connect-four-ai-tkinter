...
class GameScreen(tk.Frame):
    ...
    def __init__(self, app, rows, columns, connect_amount, user1, user2):
        ...
        self.top_canvas = tk.Canvas(
            ...
            self, width=self.board_frame.winfo_reqwidth(),

            height=top_canvas_height, bg=self.TOP_CANVAS_COLOR,
        ...
        for symbol in range(3):
            ...
            symbol_left_x = start_x + symbol * wait_symbol_gap \

                + symbol * wait_symbol_size + wait_symbol_gap
            ...
            self.wait_symbols.append(self.top_canvas.create_oval(
                ...
                fill=self.WAIT_SYMBOL_COLOR, width=1, outline='black'
        ...
        self.left_arrow = self.top_canvas.create_polygon(
            ...
            left_tip_x, tip_y, left_side_x, top_y, left_side_x, bottom_y,

            fill=self.ARROW_COLOR, activefill=self.ARROW_ACTIVE_COLOR, width=1,
        ...
        self.right_arrow = self.top_canvas.create_polygon(
            ...
            right_tip_x, tip_y, right_side_x, top_y, right_side_x, bottom_y,
        ...
        self.down_arrow = self.top_canvas.create_polygon(
            ...
            down_left_x, top_y, down_right_x, top_y, down_tip_x, down_tip_y,
